...
export default {
  ...
  orchestration: {
    ...
    reservePool: '备用资源池',
    compositePool: '组合渠道',
    compositePoolDesc: '带故障转移链的聚合渠道',
    enableToAppend: '启用后将追加到活跃序列末尾',
    allActive: '所有渠道都处于活跃状态',
    noCompositeChannels: '备用池中无组合渠道',
    openWebsite: '打开官网',
    requests: '请求',
    requestStats: '请求统计',
    minutes15: '15分钟:',
  ...
  addChannel: {
    ...
    serviceTypeComposite: '复合渠道',
    importResponsesChannel: '复用 Responses 渠道',
    importResponsesChannelHint: '从现有 Responses 渠道复制 Base URL 和 API 密钥（仅显示已配置密钥的渠道）。',
    importResponsesApplied: '保存时将从所选 Responses 渠道导入 Base URL 和 API 密钥。',
    baseUrl: '基础URL *',
    ...
    codexServiceTierOverride: 'Codex Service Tier 覆盖',
    codexServiceTierOverrideOff: '关闭',
    codexServiceTierOverrideForcePriority: '对缺失/default 强制 priority',
    ...
    responsesEncryptedReasoningMode: '加密推理内容',
    responsesEncryptedReasoningModeAuto: '自动',
    responsesEncryptedReasoningModeAlways: '始终包含',
    responsesEncryptedReasoningModeOff: '关闭',
    ...
    targetModelPlaceholderGemini: '例如：gemini-3-flash',
    targetModelPlaceholderMessages: '例如：claude-3-5-sonnet',
    thinkingSuffixNone: '不使用思考后缀',
    thinkingSuffixTooltipNone: '不使用思考后缀（按原模型名发送）',
    thinkingSuffixTooltip: '思考后缀：({suffix})',
    thinkingSuffixTooltipUnknown: '未知后缀：({suffix})（仍会按原样发送）',
    fetchModelsTooltip: '从上游获取模型列表',
    fetchModelsFailed: '从上游获取模型列表失败',
    saveChannelFirst: '请先保存渠道后再获取模型',
    ...
    modelRouting: '模型路由',
    compositeMappingsHint: '配置每个模型应由哪个渠道处理。模式从上到下依次匹配。',
    compositeFailoverHint: '配置每个模型的故障转移链。第一个渠道为主渠道，其余为备用渠道（按顺序尝试）。',
    noCompositeMappings: '至少需要一个映射。添加模型模式并选择目标渠道。',
    modelPattern: '模型模式',
    modelPatternPlaceholder: '例如：haiku, opus, *',
    targetChannel: '目标渠道',
    targetModelOptional: '覆盖模型',
    targetModelOptionalPlaceholder: '可选',
    noClaudeChannels: '无可用的 Claude 兼容渠道',
    availableChannels: '可用渠道',
    addMapping: '添加映射',
    selectModel: '选择模型',
    mappingOrder: '映射顺序（拖拽调整）',
    mappingsCount: '个映射',
    clickModelToAdd: '点击模型标签添加映射',
    targetChannelNotActive: '目标渠道未启用',
    noWildcardWarning: '未配置通配符（*）兜底规则，无法匹配的模型将失败。',
    addWildcard: '添加兜底规则',
    // New failover chain keys
    modelMappings: '模型故障转移链',
    ...
    compositeEmptyPattern: '模式不能为空',
    compositeTargetRequired: '请选择目标渠道',
    compositeMissingTargetChannel: '目标渠道不存在',
    compositeInvalidTargetChannel: '目标渠道必须是 Claude 类型',
    compositeDuplicatePattern: '重复的模式：{pattern}',
    compositeWildcardMultiple: '通配符 (*) 只能出现一次',
    compositeWildcardLast: '通配符 (*) 必须放在最后一条映射',
    compositePatternRequired: '必须配置模式 "{pattern}"',
    compositeMinFailover: '模式 "{pattern}" 需要至少 2 个渠道（1 个主渠道 + 1 个备用）',
    compositeInvalidServiceType: '渠道 "{channel}" 不是 Claude 兼容类型',
    // Tabs
    configTab: '配置',
    quotaTab: '配额',
    rateLimitTab: '限流',
  ...
  requestLog: {
    ...
    continueThinkingHeld: 'Continue-thinking 保持中：第 {round} 轮',
    continueThinkingFoldedReturn: 'Continue-thinking 合并返回：第 {round} 轮返回客户端',
    providerType: '供应商类型',
    ...
    settings: '设置',
    polling: '轮询',
    clickToDisableSSE: '点击关闭 SSE，使用轮询模式',
    clickToEnableSSE: '点击启用 SSE 实时流',
    ...
    autoRefreshIntervalDesc: 'SSE 关闭时的轮询间隔（1-60 秒）',
    ...
    fastMode: '快速模式',
    serviceTierOverridden: '由代理强制 priority',
    priorityDisabledByProxy: '由代理禁用 priority',
  ...
  apiKeys: {
    ...
    isAdminEditHint: '管理员权限仅可在创建密钥时设置',
    rateLimit: '速率限制',
    rateLimitRpm: '速率限制 (RPM)',
    ...
    keyCopied: '密钥已复制到剪贴板',
    copyError: '复制密钥失败',
    confirmRotate: '轮换 API 密钥',
    rotateWarning: '旧密钥会立即失效。轮换后请复制新密钥。',
    rotateConfirmText: '确定要立即轮换密钥 "{name}" 吗？',
  ...
  oauth: {
    ...
    accountDetails: '账户详情',
    resetCredits: '重置额度',
    resetCreditsRemaining: '剩余 {count} 次',
    resetCreditsRemainingTotal: '剩余 {count} / {total} 次',
    resetCreditItem: '额度 #{index}',
    resetCreditCreatedAt: '创建时间: {time}',
    resetCreditExpiresAt: '过期时间: {time}',
    resetNow: '重置',
    confirmResetCredit: '确认重置',
    resetCreditConfirmWarning: '此操作会消耗 1 次重置额度，并重置符合条件的 Codex 速率限制窗口。',
    resetCreditConfirmDesc: '当前剩余 {count} 次重置额度。是否继续？',
    resetCreditSuccess: 'OAuth 配额已重置',
    resetCreditFailed: '重置 OAuth 配额失败',
    resetCreditFailedWithError: '重置 OAuth 配额失败: {error}',
    createdAt: '创建',
    expiresAt: '过期',
    // 积分
  ...
  debugLog: {
    ...
    enabled: '已启用',
    disabled: '已禁用',
    enableDescription: '请求头会始终保存。启用后会额外保存请求体和响应体。',
    retentionSection: '日志保留期',
    retentionHours: '保留时长',
    retentionDescription: '超过此时间的调试日志将被自动清理。',
    fullRetentionHours: '完整保留期（请求头 + 请求体）',
    fullRetentionDescription: '超过此时间后，将删除请求/响应体，但保留请求头。',
    headerRetentionHours: '请求头保留期（仅请求头）',
    headerRetentionForever: '永久保留请求头',
    headerRetentionDescription: '超过此时间后，仅含请求头的调试数据会被删除；开启永久保留后不会自动删除。',
    forever: '永久',
    ...
    confirmPurgeHeaders: '清除请求头',
    confirmPurgeHeadersDesc: '确定要清除所有已保存的请求头和响应头吗？已有请求体/响应体会保留。',
    purged: '已清除 {count} 条调试日志',
    headersPurged: '已清除 {count} 条记录的请求头，并移除 {deleted} 条空记录',
    purgeFailed: '清除调试日志失败',
    purgeHeadersFailed: '清除请求头失败',
  ...
  debugModal: {
    ...
    modifiedHeadersSummary: '已修改 {count} 个',
    removedHeadersHint: '这些请求头已被 CC-Bridge 捕获，但在发送到上游前被移除了。',
    modifiedHeadersHint: '这些请求头来自客户端，但在发送到上游前被 CC-Bridge 修改了。',
    removedBeforeUpstream: '发送上游前已移除',
    removedByRule: '匹配规则：{rule}',
    modifiedBeforeUpstream: '发送上游前已修改',
    modifiedTo: '发送为：{value}',
  ...
  forwardProxy: {
    title: '正向代理',
    discoveryTabTitle: '代理发现',
    discoveryTitle: '正向代理发现',
    discoveryDescription: '记录经过代理的主机，包括盲隧道目标，帮助你判断哪些域名应该加入拦截列表。',
    discoveryHost: '主机',
    discoveryTransport: '传输方式',
    discoveryIntercepted: '是否已拦截',
    discoverySeenCount: '出现次数',
    discoveryLastRequest: '最近请求',
    discoveryHeadersTitle: '请求头',
    discoveryFirstSeen: '首次出现',
    discoveryLastSeen: '最近出现',
    discoveryHeadersChip: '{count} 个请求头',
    discoveryShowSensitiveHeaders: '显示敏感请求头',
    discoveryHideSensitiveHeaders: '隐藏敏感请求头',
    discoveryEmpty: '还没有发现任何代理主机。先让流量经过正向代理，这里就会逐步累积候选域名。',
    discoveryLoadFailed: '加载正向代理发现列表失败',
    discoveryClearFailed: '清空正向代理发现列表失败',
    discoveryPromoteFailed: '加入拦截域名失败',
    discoveryEnabled: '发现已开启',
    discoveryDisabled: '发现已关闭',
    discoveryToggleHint: '开启时将记录经过代理的主机。不需要时关闭可减少开销。',
    discoveryOffInfo: '发现功能已关闭，不会记录代理主机。',
    discoveryToggleFailed: '切换发现状态失败',
    addToInterceptDomains: '加入拦截',
    alreadyIntercepted: '已在拦截中',
    ...
    xInitiatorOverrideModeWindowedQuota: '窗口配额',
    xInitiatorOverrideModeWindowedCost: '窗口成本',
    xInitiatorOverrideModeFixedShort: '固定',
    xInitiatorOverrideModeRelativeShort: '倒计时',
    xInitiatorOverrideModeWindowedQuotaShort: '配额',
    xInitiatorOverrideModeWindowedCostShort: '成本',
    xInitiatorOverrideDuration: '持续时间（秒）',
    xInitiatorOverrideOverrideTimes: '覆写次数',
    xInitiatorOverrideTotalCost: '总成本预算',
    xInitiatorOverrideHintFixedWindow:
      '按域名分别生效：第一次 user 请求会启动窗口；之后的 user 请求会在固定过期时间到达前改写为 agent。',
    xInitiatorOverrideHintRelativeCountdown:
      '按域名分别生效：第一次 user 请求会启动窗口；之后的 user 请求会改写为 agent，并且每次成功改写都会刷新倒计时。',
    xInitiatorOverrideHintWindowedQuota:
      '按域名分别生效：第一次 user 请求会启动窗口且不会消耗配额；之后的 user 请求会改写为 agent，直到配额耗尽或时间到期。',
    xInitiatorOverrideHintWindowedCost:
      '按域名分别生效：第一次 user 请求会启动窗口；窗口活动期间，之后的 user 请求会改写为 agent，并且该域名下所有经正向代理转发的请求都会累计到当前成本预算，直到预算被超出或时间到期。',
    xInitiatorOverrideOffShort: 'X-Initiator 已关闭',
    xInitiatorOverrideIdle: '空闲',
    xInitiatorOverrideToolbarTooltip: '按域名统计的 X-Initiator 覆写运行状态',
    xInitiatorOverrideActiveDomains: '{count} 个活动域名',
    xInitiatorOverrideToolbarRemaining: '距离最近一次过期还剩 {seconds} 秒',
    xInitiatorOverrideToolbarQuotaRemaining: '配额 {remaining}/{total} - {seconds} 秒',
    xInitiatorOverrideToolbarCostRemaining: '成本 {used}/{total} - {seconds} 秒',
    xInitiatorOverrideTooltipDomainQuota: '剩余覆写 {remaining}/{total}',
    xInitiatorOverrideTooltipDomainQuotaTime: '{remaining}/{total} · {seconds} 秒',
    xInitiatorOverrideTooltipDomainCost: '成本 {used}/{total}',
    xInitiatorOverrideTooltipDomainCostTime: '{used}/{total} · {seconds} 秒',
    xInitiatorOverrideTooltipDomainTime: '剩余 {seconds} 秒',
    caCertSection: 'CA 证书',
