...
export default {
  ...
  addChannel: {
    ...
    codexServiceTierOverride: 'Codex Priority Override',
    ...
    codexServiceTierOverrideHint:
      'Proxy override for this channel: if a Codex request omits service_tier or sends "default", cc-bridge will rewrite it to "priority". This can increase billed cost.',
